...
# The accelerator parameter in the menus only put the accelerator string
# Here we bind the accelerator command with the function that must be executed
